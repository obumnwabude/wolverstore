...
module.exports = (req, res, next) => {
  let userId;
  if (res.locals.review != undefined) userId = res.locals.review.customer.userId;
  else if (res.locals.order != undefined) userId = res.locals.order.customer.userId;
  else if (res.locals.cart != undefined) userId = res.locals.cart.userId;
